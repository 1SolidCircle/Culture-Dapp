...
class Tracks extends React.Component {
    ...
    handleSubmit(e) {
        e.preventDefault();
        let { artist, artistOwnership, artistRoleId, agreement, chill, focus, justListen, hyped, heavy, soulful, eclectic, electronic, 
        ...
        axios.post(`${configs.prod}/api/track/create`, { 
            ...
            list_on_profile: listOnProfile, track: track, track_pic: track_pic, user_id: this.props.user.id
        })
            .then(response => {
                    ...
                    <Col md={{ span: 8, offset: 2 }}>
                        <Form onSubmit={(e) => this.handleSubmit(e)}>
                            <fieldset disabled={this.state.isLoading} className={this.state.isLoading ? 'opacity-5' : ''}>
                                ...
                                <Form.Row>
                                    <Col>
                                        <Button className="submitTrack" variant="primary" onClick={(e) => this.handleSubmit(e)}>Add New Track</Button>
                                    </Col>
                                </Form.Row>
                            </fieldset>
                        </Form>
